...
"""
    ---- pyping integration for python >= 3.0 ----
...
class Ping(object):
    def __init__(self, destination, timeout=1000, packet_size=55, own_id=None,
        ...
        try:
            # FIXME: Use destination only for display this line here? see:
            # https://github.com/jedie/python-ping/issues/3
    ...
    def print_success(self, delay, ip, packet_size, ip_header, icmp_header):
        ...
        packet_size, from_info, icmp_header["seq_number"], ip_header["ttl"],
        delay)
    ...
    def print_exit(self):
        ...
        msg = "%d packets transmitted, %d packets received, %0.1f%% packet " \
              "loss" % (
    ...
    def do(self):
        ...
        try:  # One could use UDP here, but it's obscure
            ...
            if err == 1:
                ...
                evalue = etype(
                    "%s - Note that ICMP messages can only be send from "
                    "processes running as root." % evalue
                )
    ...
    def send_one_ping(self, current_socket):
        ...
        checksum = calculate_checksum(
            header + data)  # Checksum is in network order
        ...
        try:
            current_socket.sendto(packet, (
            self.destination, 1))  # Port number is irrelevant for ICMP
